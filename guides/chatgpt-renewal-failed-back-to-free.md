---
title: "ChatGPT Plus / Pro 续费失败变回 Free：订阅排查"
...
跨平台续费状态难以判断时，可按[AI 订阅付款排障决策树](https://he20000405-pixel.github.io/resources/ai-subscription-payment-troubleshooting/)依次核对银行是否仍在处理、平台是否已经收款、订阅是否有效，以及当前账号是否显示会员。
