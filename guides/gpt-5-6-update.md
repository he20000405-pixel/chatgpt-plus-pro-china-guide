...
OpenAI 官方发布页将 GPT-5.6 分成三个能力层级：

| 模型层级 | 官方定位 | 对 ChatGPT 用户的实际意义 |
| --- | --- | --- |
| GPT-5.6 Sol | 旗舰模型 | 面向复杂编程、研究、科学、网络安全、计算机使用与设计任务 |
| GPT-5.6 Terra | 平衡模型 | 偏向能力、速度和成本的日常平衡 |
| GPT-5.6 Luna | 更快、更经济的层级 | 偏向大量日常任务和成本效率 |

不要根据第三方截图猜测账号权益。最可靠的判断入口仍是 ChatGPT 账号内的模型选择器。
...
OpenAI 的 ChatGPT Business 模型限制文档列出：

- GPT-5.6 Luna：128K；
- GPT-5.6 Terra：128K；
- GPT-5.6 Sol：272K。

这些数字来自特定官方模型限制页面，不应自动推断为所有产品、所有计划和所有入口永久保持相同。实际使用仍以当前产品界面为准。
...
2. 选择 ChatGPT Plus；
3. 使用支付宝或微信付款并取得卡密；
4. 到 <https://chonggrok.com/verify> 验证卡密；
5. 提交本次升级所需 session，不提交密码；
6. 确认自己的账号后自动充值；
7. 回 ChatGPT 检查 Plus 状态和模型选择器；
8. 退出并重新登录，刷新旧 session。

### Pro 100 美金 / Pro 200 美金

两个名称是 chonggrok.com 的页面服务方案。用户应先联系客服确认账号状态、具体交付内容、实时金额和验收规则，再由客服使用海外信用卡协助付款。不要把 Pro 方案写成 Plus 自动核销。

## 需要避免的误导

- “开通 Plus 就 100% 立即出现 GPT-5.6”不准确；
...
- [OpenAI Help Center：ChatGPT Business Models & Limits](https://help.openai.com/en/articles/12003714-chatgpt-business-models-limits)
